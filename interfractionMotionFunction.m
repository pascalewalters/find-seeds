% This function calculates the mean position of the four seeds in 3D for one
...
% Params:
%   dicomUID: folder name of the current imaging session, e.g.
%       'img_1.3.46.423632.335322201752171147687.46' (string)
%   row: the row of the Excel file for the current imaging session, e.g.
%       'E33' (string)

function interfractionMotionFunction(dicomUID, row)
tic

xmlPath = strcat('C:\Users\pwalters\Documents\patient_11111529\IMAGES\', dicomUID, '\_Frames.xml');
